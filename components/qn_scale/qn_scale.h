...
class QNScale : public ble_client::BLEClientNode, public Component {
 public:
  ...
  void set_impedance_r1_sensor(sensor::Sensor *sensor) { impedance_r1_sensor_ = sensor; }
  void set_impedance_r2_sensor(sensor::Sensor *sensor) { impedance_r2_sensor_ = sensor; }
 ...
 protected:
  ...
  sensor::Sensor *impedance_r1_sensor_{nullptr};
  sensor::Sensor *impedance_r2_sensor_{nullptr};
